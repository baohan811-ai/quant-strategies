...
position = position.mask(golden_signal, 1)
position = position.replace(0, np.nan).ffill()
position = position.mask(death_signal, 0)
...
# 19. 输出
# =========================
output_file = f"./MA策略_动态仓位版_{end_date}.xlsx"
